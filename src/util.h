...
{
    // Clamp sleep time to 10 years to avoid potential overflow issues
    int64 clampedTime = (n > 315576000000LL) ? 315576000000LL : n;
    std::this_thread::sleep_for(std::chrono::milliseconds(clampedTime));
}
#endif
