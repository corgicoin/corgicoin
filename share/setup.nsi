...
!define URL http://www.corgicoin.org/
...
OutFile corgicoin-0.6.3-win32-setup.exe
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\CorgiCoin.lnk" $INSTDIR\corgicoin-qt.exe
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Uninstall CorgiCoin.lnk"
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\CorgiCoin.lnk"
